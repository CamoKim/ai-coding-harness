...
The Behavioral Lab is a manual or semi-automated regression fixture for E1 autonomy and E2 routing. It never launches Codex, changes model/profile/telemetry settings, or accesses external, production, shared, credentialed, network, database, or container state.
