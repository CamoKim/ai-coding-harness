...
Personal AI Coding Harness v0.1 provides a small, reusable foundation for working with Codex across repositories. It standardizes durable instructions and the interface used to invoke project-owned verification without centralizing project knowledge.
